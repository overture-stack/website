...
<Note title="Ego User Guide">For information on setting up users, groups and applications in Ego, please refer to our documentation on [using the Ego admi UI](/documentation/ego/user-guide/admin-ui/).</Note>
