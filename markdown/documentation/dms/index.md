...
| Object Storage Services | Secure object storage for data transfer (e.g. [Amazon S3](https://aws.amazon.com/s3/), [MS Azure](https://azure.microsoft.com/en-ca/services/storage/), Openstack with Ceph, [MinIo](https://min.io/)) |
