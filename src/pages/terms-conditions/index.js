...
const TermsConditionsPage = () => (
  <main className="TermsConditionsPage pb3">
    {/* HERO */}
    ...
    <article className="container section py2">
      <section>
        <p>
          <span className="bold">May 16, 2018:</span> Thank you for visiting the Overture website. Please read the Terms and Conditions carefully before using this website.
        </p>
      </section>
      ...
      <section>
        <Heading><span className="bold pr2">2</span>Website Privacy Statement</Heading>
        <p>
          The <a href="/privacy">Website Privacy Statement </a> applies to your use of this website. Please ensure you have read and agree with the <a href="/privacy">Website Privacy Statement</a>. By visiting and using this Site, you are consenting to the collection, use and disclosure of your Personal Information while visiting the Site.
        </p>
      </section>
      ...
      {/* website privacy statement */}
      <section>
        <Heading><span className="bold pr2">3</span>Proprietary Rights</Heading>
      ...
      <section>
        <Heading><span className="bold pr2">5</span>Links to Third Party Websites</Heading>
        <p>Certain links on this Site may take you to other websites. All such other websites are independent from this Site and OICR provides these links as a convenience only.</p>
        <p>OICR has no control over, and is not responsible for, the content of any such linked pages. OICR makes no representation or warranty regarding, and does not endorse, any linked websites, the information appearing thereon or any of the products or services described. If you follow these links, you will leave this Site. If you decide to visit any linked site, you do so at your own risk and it is your responsibility to take all protective measures to guard against viruses and other destructive elements. The terms of use and privacy policies applicable to such websites may be different than those applicable to this website. OICR may terminate a link at any time.</p>
        <p>OICR welcomes links to this Site. However, you agree that if you want to link to this Site, your website shall not:</p>
        <ul>
          <li className="bullet">create frames around any part of this Site or use other techniques that alter the visual presentation of this         Site;</li>
          <li className="bullet">imply that OICR is endorsing you or any other person, or your or such other person’s products or services; </li>
          <li className="bullet">imply an affiliation between you or any other person, or your or such other person’s products or services,         and OICR without the prior written consent of OICR; </li>
          <li className="bullet">misrepresent your relationship or that of any other person with OICR or present false, misleading or         otherwise damaging information or impressions about OICR or any of its products or services; or</li>
          <li className="bullet">contain materials that may be interpreted as distasteful, harmful, offensive, infringing or inaccurate.</li>
        </ul>
        <p>You acknowledge and agree that OICR reserves the right to request, at any time and in its sole discretion, that you remove all links or any particular link to the Site or any other OICR website or to a page of the Site or any other OICR website.</p>
      </section>

      {/* Disclaimers */}
      <section>
        <Heading><span className="bold pr2">6</span>Disclaimers</Heading>
        <p>This Site is provided on an “as-is, as available” basis. While OICR believes the Content on this Site to be correct, OICR makes no representations or warranties regarding the accuracy, completeness or currency of any Content displayed on this Site.</p>
        <p>This Site is designed for informational purposes and for event registration only. The Site does not provide medical advice or professional services, and should not be relied upon as such. The information provided on this Site is not intended as a substitute for medical professional help or advice, but is to be used only as an aid in understanding current medical knowledge. A physician should always be consulted for any health problem or question, or medical condition. Use of or reliance on the information displayed on this Site is at your own risk.</p>
      </section>


      {/* Limitations of Liability */}
      <section>
        <Heading><span className="bold pr2">7</span>Limitations of Liability</Heading>
        <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL OICR AND ITS RESPECTIVE DIRECTORS, OFFICERS, MEMBERS, AGENTS, EMPLOYEES, REPRESENTATIVES AND LICENSORS (COLLECTIVELY THE “OICR PARTIES”) BE LIABLE FOR ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL OR CONSEQUENTIAL DAMAGES WHATSOEVER (INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF PROFITS, FAILURE TO REALIZE EXPECTED SAVINGS, INTERRUPTION OF ACTIVITIES, OR ANY OTHER PECUNIARY OR ECONOMIC LOSS) ARISING OUT OF THE USE OF OR INABILITY TO USE THIS SITE, EVEN IF ANY OF THE PARTIES HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN ANY EVENT, THE PARTIES’ TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES AND CAUSES OF ACTION, WHETHER IN CONTRACT OR TORT (INCLUDING NEGLIGENCE) OR OTHERWISE, SHALL BE LIMITED TO THE AMOUNT ACTUALLY PAID BY YOU TO ACCESS THIS SITE, IF ANY. IN NO EVENT SHALL ANY OICR PARTY BE LIABLE FOR DAMAGES OR LOSSES OF ANY KIND ARISING FROM THE USE OF ANY HYPERLINKED WEBSITE.</p>
        <p>BY USING THE CONTENT, YOU AGREE TO INDEMNIFY OICR AND ITS CONTENT PROVIDERS FROM ANY AND ALL LIABILITY, LOSS, INJURY, DAMAGES, COSTS AND EXPENSES (INCLUDING LEGAL FEES AND EXPENSES) ARISING FROM YOUR USE OF THE CONTENT.</p>
      </section>


      <section>
        <Heading><span className="bold pr2">8</span>General</Heading>
        <p>These Terms and Conditions shall be governed by and construed in accordance with the laws in force in the province of Ontario and the federal laws of Canada applicable therein, and any dispute arising hereunder shall be resolved exclusively by the courts in the province of Ontario.</p>
      </section>
    </article>
  </main>
