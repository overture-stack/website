...
import { Button, H1, H2, H3, P1, P2, P3, Hero, Search, YellowButton, LinkHelper as Link } from 'components';
import { OVERTURE_GITHUB_LINK, GITHUB_ISSUES_LINK, SLACK_LINK, GI_PROGRAM_LINK } from 'constants/external-links';
        ...
        <div className="container">
          <div className="white-section__holder">
            ...
            <div className="white-section__title-holder">
              ...
              <P2>
                We are the <Link to={GI_PROGRAM_LINK}>Genome Informatics team from Ontario's Institute for Cancer Research</Link>. At OICR we develop new software, databases and other necessary components to store, 
