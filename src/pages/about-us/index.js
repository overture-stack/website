...
import { Button, H1, H2, H3, P1, P2, P3, Hero, Search, YellowButton, LinkHelper } from 'components';
        ...
        <div className="container">
          <div className="white-section__holder">
            ...
            <div className="white-section__title-holder">
                <H3>Making big-genomics data accessible one byte at a time.</H3>
              </div>

              <P2>
                We are the Genome Informatics team from Ontario's Instituite for Cancer Research. At OICR we develop new software, databases and other necessary components to store, 
                organize and compute over the large and complex datasets being generated by our cancer research programs. 
                Embodying OICR's values of collaboration and community, we are firm believers in open-source and open-science. As such our resources and expertise are shared with the data science community at large.</P2>

            <div className="white-section__title-holder">
                <H3>The Overture Story</H3>
              </div>
                <P2>
                Overture's story began in 2017 when organizations started approaching us, seeking guidance on deploying ICGC components within their environments. At the same time, we were picking up new projects and found ourselves rebuilding the same foundational features. In pursuit of efficiency, we created Overture, a collection of modular microservices designed to expedite our application development in a scalable manner. Learning from past challanges, we've refined our toolkit, which we're now eager to extend to the broader data science and research software community.
                </P2>
            </div>
