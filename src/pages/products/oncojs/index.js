...
import lolliplotScreen from "./images/lolliplot_screen.png";
import oncogridScreen from "./images/oncogrid_screen.jpg";
import sapienScreen from "./images/sapien_screen.jpg";
import survivalplotScreen from "./images/survivalplot_screen.jpg";
import pathwayviewerScreen from "./images/pathwayviewer_screen.jpg";
import "./style.scss";
import { H2 } from "../../../components/Typography/index";
import WindowGui from "../../../components/WindowGui/index";
      ...
      <div className="container">
        <div className="columns column items-center pt4">
          <div className="column is-5-desktop pt2">
            ...
            <div className="mt2">
              <a className="bold text-magenta" 
                 target="_blank"
                 href="https://portal.gdc.cancer.gov/genes/ENSG00000183914">Live example > </a>
            </div>
          </div>
      ...
      <div className="container">
        <div className="columns column items-center pt4">
          ...
          <div className="column pt2 is-5-desktop pl3 pt2">
            ...
            <p className="pb2">Identify trends in mutation co-occurrence by plotting mutations and donors together on an Oncogrid.</p>
            ...
            <div className="mt2">
              <a className="bold text-magenta" 
                 target="_blank"
                 href="https://dcc.icgc.org/analysis/view/oncogrid/ce6fd9fd-b76e-488d-88a5-93bdc690f79e">Live example > </a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="columns column items-center pt4">
          <div className="column pt2 is-5-desktop pt2">
            ...
            <p className="pb2">Visualize and compare datasets to determine probable health outcomes and their frequency in patient groups. </p>
            ...
            <div className="mt2">
              <a className="bold text-magenta" 
                 target="_blank"
                 href="https://dcc.icgc.org/analysis/view/phenotype/15c7c81a-7717-49e3-a0f7-be09fdc400b6">Live example > </a>
            </div>
        ...
        <div className="columns column items-center pt4">
          ...
          <div className="column pt2 is-5-desktop pl3 pt2">
            ...
            <div className="mt2">
              <a className="bold text-magenta" 
                 target="_blank"
                 href="https://portal.gdc.cancer.gov/">Live example > </a>
            </div>
      ...
      <div className="container">
        <div className="columns column items-center pt4">
          <div className="column pt2 is-5-desktop pt2">
            ...
            <p className="pb2"> A straightforward component for visualization of reactome pathways.</p>
