    ...
    return (
      <Layout>
        <main className="OurVisionPage">
          <Hero
            title="Our Vision"
            subtitle="Our vision is to help research, healthcare, and patient
            ...
            <div className="container flex items-center">
              ...
              <div className="column is-8">
                ...
                <p className="">
                  ...
                  With rapidly expanding datasets at the heart, we've built our
                  bioinformatics bundle to track, transfer, and secure genomic
          ...
          <section className="hero bg-grey py3">
            <div className="container flex items-center">
              ...
              <div className="column is-8">
                ...
                <div className="my3 yellow-bar" />
                <p className="">
                  We are strong believers in open-source software, open science,
                  and open communication. Don’t hesitate to follow our team
                  activities on{" "}
                  <a href="https://waffle.io/overture-stack/roadmap">GitHub</a>{" "}
                  by taking a look at upcoming or in-progress tickets, or even
                  be the first to test out a feature detailed in a Pull Request.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="container flex items-center">
              ...
              <div className="column is-8">
                ...
                <p className="">
                  ...
                  and submission all the way to data dissemination and analysis,
                  leading to a deep understanding of the genomic data lifecycle.
                  The Overture stack contains a wide array of components for
                  cloud infrastructure, data shepherding, and analysis.
                </p>
              </div>
            </div>
          </section>
