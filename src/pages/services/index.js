...
import { H1, H2, H4, Hero, Layout, Button } from "../../components";
import "./styles.scss";
  ...
  <Layout>
    <main className="ServicesPage">
      ...
      <Hero
        ...
        subtitle="Interested by our expertise or software stack and need help
      getting started? Want to collaborate with us on exciting new
      projects? We are here to help!"
      />

      {/* Academic Collaborations  */}
      <section className="hero">
        <div className="container flex items-center py3">
          {/* Copy  */}
      ...
      {/* Academic Collaborations  */}
      <section className="hero">
        <div className="container flex items-center py2">
          {/* Copy  */}
          <div className="column">
