...
import { Button, Icon, ProductsPopup, NavLink } from 'components';
...
class NavBar extends Component {
  ...
  render() {
    ...
    let productsArrowClass = productMenuOpen ? 'products-arrow open' : 'products-arrow closed';
      ...
      <nav className="NavHeader navbar is-fixed-top" aria-label="main navigation">
        <div className="nav-container">
          <div className="navbar-brand">
            ...
            <button className={burgerClass} onClick={() => this.props.toggleMobileMenu()}>
              <span />
              <span />
              <span />
            </button>
          ...
          <div className={navbarMenuClass} id="navMenu">
            <div className="navbar-start items-center">
              ...
              <NavLink closeMenus={this.props.closeMenus} url="/case-studies" name="Case Studies" />

              <NavLink closeMenus={this.props.closeMenus} url="/about-us" name="About Us" />
              <NavLink closeMenus={this.props.closeMenus} url="/services" name="Services" />
              <NavLink closeMenus={this.props.closeMenus} url="/contact" name="Contact" />
            </div>
